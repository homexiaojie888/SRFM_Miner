...
public class MainTest_SRFM_Miner {
	...
	public static void main(String [] arg) throws IOException, InterruptedException {
		...
		for (int i = 0; i < 1; i++) {
			...
			String output = ".//Patterns_SRFMiner_" + strInput[i];
            long[] tsNow=ts_now[i];
...
//				Thread.sleep(10000);
				...
				AlgoSRFMminer algoSRFMminer = new AlgoSRFMminer();
	...
	private static void OutputExp(int[] DataSize, String input) throws IOException {
		String experimentFile = ".//Exp_SRFMiner_"+input;
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTest_SRFM_Miner.class.getResource(filename);
